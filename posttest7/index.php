<?php
   ...
   if(isset($_POST['submit'])){
       ...
       "INSERT INTO booking (nama, tanda, email, gender, tanggal, gambar, tanggal_booking) 
       VALUES ('$nama', '$tanda', '$email', '$gender', '$tanggal', '$gambar_baru','$tanggal_booking')");
